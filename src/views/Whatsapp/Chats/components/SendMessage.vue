            ...
            <div class="grid grid-cols-2 gap-2 items-center">
                ...
                <div class="flex flex-col  min-w-full">
                    ...
                    <div class="flex gap-2 justify-end mt-3">
                        <n-select size="small" v-model:value="valuesSend.templateId" :options="messageOptions"
                            placeholder="Mensaje" :disabled="patientSend.length == 0" />

                        <n-button :disabled="!valuesSend.templateId" size="small" type="primary" :loading="loading"
