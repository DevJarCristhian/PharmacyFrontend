...
import { Get } from '../../../../services/interfaces/people/visitor.interfaces';
...
<template>
    <n-modal :show="show" :on-close="closeModal" @esc="closeModal()" preset="card" :mask-closable="false"
        title="Visitador" close-on-esc style="width: 600px;" :auto-focus="false">
        ...
        <n-form ref="formRef" :model="items" class="-mt-2">
            ...
            <n-grid x-gap="12" cols="12 100:1 450:12">
                <n-form-item-gi span="12" label="Pais">
