                ...
                <n-form ref="formRef" :model="formData">
                    <n-grid x-gap="12" cols="12 200:1 450:12">
                        <n-form-item-gi span="6" label="Nombre del Doctor">
                            <n-input v-model:value="formData.doctorName" readonly placeholder="" />
                        </n-form-item-gi>

                        <n-form-item-gi span="6" label="Institución">
                            <n-input v-model:value="formData.institutionName" readonly placeholder="" />
                        </n-form-item-gi>
                    </n-grid>

                    <n-grid x-gap="12" cols="12 200:1 450:12">
                        <n-form-item-gi span="3" label="Fecha Programación">
                            <n-input v-model:value="formData.programStartDate" readonly placeholder="" />
                        </n-form-item-gi>

                        <n-form-item-gi span="3" label="Verificado">
                            <n-input v-model:value="formData.verified" readonly placeholder="" />
                        </n-form-item-gi>

                        <n-form-item-gi span="3" label="Consumo Medicamento">
                            <n-input v-model:value="formData.medicationConsumption" readonly placeholder="" />
                        </n-form-item-gi>

                        <n-form-item-gi span="3" label="Cantidad Canjes">
                            <n-input v-model:value="formData.quantityRedemptions" readonly placeholder="" />
                        </n-form-item-gi>
                    </n-grid>
                    ...
                    <n-grid x-gap="12" cols="12 200:1 450:12">
                        ...
                        <n-form-item-gi span="3" label="Estado Paciente">
